...
export type MessageCatalog = {
  ...
  apiProxy: {
    ...
    requestLogsEmpty: string;
    requestLogsLoading: string;
    requestLogsRefresh: string;
    requestLogsClear: string;
    requestLogsClearing: string;
    requestLogsColumns: {
      time: string;
      method: string;
      path: string;
    ...
    requestLogsExpand: string;
    requestLogsCollapse: string;
    requestLogsRequestHeaders: string;
    requestLogsRequestBody: string;
    requestLogsResponseExcerpt: string;
    requestLogsTruncated: string;
    requestLogsCopy: string;
    requestLogsCopied: string;
    requestLogsStatusSuccess: string;
    requestLogsStatusClientError: string;
    requestLogsStatusServerError: string;
    requestLogsStatusRedirect: string;
    requestLogsStatusUnknown: string;
    requestLogsBreakdownTitle: string;
    requestLogsBreakdownTotal: string;
    requestLogsBreakdownSection: string;
    requestLogsBreakdownBytes: string;
    requestLogsBreakdownBar: string;
    requestLogsBreakdownModel: string;
    requestLogsBreakdownSystem: string;
    requestLogsBreakdownTools: string;
    requestLogsBreakdownMessages: string;
    requestLogsBreakdownAttachments: string;
    requestLogsBreakdownOther: string;
    requestLogsBreakdownSystemPreview: string;
    requestLogsViewFullBody: string;
    requestLogsNoBodyFile: string;
    requestLogsLoadingFullBody: string;
    requestLogsFormatting: string;
    requestLogsFormatJson: string;
    requestLogsRawView: string;
    requestLogsViewerClose: string;
    requestBodyDirLabel: string;
    requestBodyDirHelp: string;
    requestBodyDirPick: string;
    requestBodyDirClear: string;
    requestBodyDirDefault: string;
    requestBodyEnabledLabel: string;
    requestBodyEnabledOn: string;
    requestBodyEnabledOff: string;
